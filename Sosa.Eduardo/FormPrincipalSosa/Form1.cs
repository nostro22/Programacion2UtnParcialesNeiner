...
using LiberiaDispositivo;

namespace FormPrincipalSosa
{
    public partial class RPP_Sosa_Eduardo_2A : Form
    {
        public RPP_Sosa_Eduardo_2A()
        {
            InitializeComponent();
        }

        private void RPP_Sosa_Eduardo_2A_Load(object sender, EventArgs e)
        {
